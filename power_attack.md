...
* Damage helps chunk down Oppressors, and since the power attack is entirely AOE, it ignores Oppressor armor. Four damage power attacks will kill an oppressor, even if you dont perfectly hit inside the max damage radius. Conveniently, that is also the number of players in a normal team.
